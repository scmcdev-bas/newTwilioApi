...
JOIN 
    [scmc-POC].[dbo].[CUSTOMER_CONTACT] CCO ON CCC.[CONTACT_ID] = CCO.[ID]
JOIN
    [scmc-POC].[dbo].[LOOKUP] LKPT ON CCO.[TITLE] = LKPT.[LOOKUP_CODE]
JOIN
    [scmc-POC].[dbo].[LOOKUP] LKPC ON CCC.[CHANNEL_TYPE] = LKPC.[LOOKUP_CODE]
JOIN
    [scmc-POC].[dbo].[CUSTOMER_CONTACT_ACCOUNT] CCA ON CCC.[CONTACT_ID] = CCA.[CONTACT_ID]
WHERE
